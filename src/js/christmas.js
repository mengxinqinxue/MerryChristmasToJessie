...
$(function() {
    ...
    animates.step4 = function() {
        var $banner = $(".j-banner");
        $banner.addClass("opacity1 flipInX").one(animateEvents, animates.step5);
    }
    ...
    animates.step6 = function() {
        ...
        box.style.opacity = 1;
        // setTimeout(animates.step7, 2000);
    }

    //大雪花飞到左上角
    animates.step7 = function() {
        $(".j-bigSnow").addClass("bigSnow-smallPos");
    }
            ...
            $loading.find(".progres-bar")
                ...
                .one(transitionEvents, function() {
                    if (parseInt(preload.loadedPer) >= 99) {
                        $loading.find(".loading-text").text("load completed");
